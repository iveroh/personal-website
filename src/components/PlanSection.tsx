...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Mulighet for nettbutikk, bookingsystem og automatiserte skjemaer",
      "Tilpasset funksjonalitet etter dine behov",
      "Egen rådgiver, prioritetssupport og løpende oppfølging",
      "Gratis drift, supportservice og oppfølging i ettertid",
    ],
    featured: true,
  },
];
